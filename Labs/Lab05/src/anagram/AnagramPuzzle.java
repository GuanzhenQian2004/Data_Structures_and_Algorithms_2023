...
public class AnagramPuzzle {
    ...
    public void shiftLeft() {
        char temp = puzzle.removeAtHead();
        puzzle.insertAtTail(temp);
    }

    // Swaps the letters at the left and right ends of the puzzle.
    public void swapEnds() {
        char left = puzzle.removeAtHead();
        this.display();
        char right = puzzle.removeAtTail();
        this.display();
        puzzle.insertAtHead(right);
        this.display();
        puzzle.insertAtTail(left);
        this.display();
    }
