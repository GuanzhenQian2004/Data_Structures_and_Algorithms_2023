    ...
    public static void main(String[] args) {
        ...
        for (i = 0; i < 15; i++) {
            ...
            System.out.println( /* array value */  arr[i] + "\t"
                    + /* hash value */                 hashFunc(arr[i]) + "\t"
                    + /* hash value mod table size */ (hashFunc(arr[i]) % 40) + "\t"  );
        }
        ...
        for (i = 0; i < 15; i++) {
            ...
            System.out.println( /* array value */  arr[i] + "\t"
                    + /* hash value */                 hashFunc(arr[i]) + "\t"
                    + /* hash value mod table size */ (hashFunc(arr[i]) % 20) + "\t"
                    + /* hash value / table size */   (hashFunc(arr[i]) / 20));
        }
        ...
        for (i = 0; i < 15; i++) {
            ...
            System.out.println( /* array value */       arr[i] + "\t"
                    + /* hash value */                  hashFunc(arr[i]) + "\t"
                    + /* hash value mod table size */  (hashFunc(arr[i]) % 10));
        }
        ...
        for (i = 0; i < 15; i++) {
            ...
            System.out.println( /* array value */       arr[i] + "\t"
                    + /* hash value */                  hashFunc(arr[i]) + "\t"
                    + /* hash value mod table size */  (hashFunc(arr[i]) % 5));
        }
    }
